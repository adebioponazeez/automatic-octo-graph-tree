"""
OpenAI Provider implementation for Octo Harness.
"""
...
class OpenAIProvider(BaseProvider):
    """
    OpenAI API provider for GPT-4o, GPT-4o-mini, o1, o3-mini models.
    """
    ...
    def _get_headers(self) -> Dict[str, str]:
        headers = {
            ...
            "User-Agent": "OctoHarness-Router/1.0",
        }
        if self.api_key:
    ...
    async def complete(self, request: CompletionRequest, model_spec: ModelSpec) -> CompletionResponse:
        ...
        try:
            ...
            if resp.status_code != 200:
                err_text = f"OpenAI API error {resp.status_code}: {resp.text}"
            ...
            return CompletionResponse(
                id=data.get("id", f"openai-{int(time.time())}"),
                model=model_spec.model_id,
