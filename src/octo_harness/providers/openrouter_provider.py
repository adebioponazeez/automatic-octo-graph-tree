"""
OpenRouter Provider implementation for Kimi K3, DeepSeek R1/V3, Qwen 2.5, Llama 3.3, and open-weights.
"""
...
class OpenRouterProvider(BaseProvider):
    """
    OpenRouter API provider. Unifies access to Kimi K3, DeepSeek R1, Qwen 2.5 Coder,
    Llama 3.3 70B, and hundreds of top open-weight models under a single API key.
    """
    ...
    def __init__(
        ...
        site_url: str = "https://github.com/adebioponazeez/automatic-octo-graph-tree",
        site_name: str = "Octo Harness Sovereign OS",
    ...
    async def complete(self, request: CompletionRequest, model_spec: ModelSpec) -> CompletionResponse:
        ...
        try:
            ...
            if resp.status_code != 200:
                err_text = f"OpenRouter API error {resp.status_code}: {resp.text}"
        ...
        try:
            ...
            try:
                ...
                if resp.status_code == 200:
                    ...
                    health.models_available = models[:10]  # Store top 10 models
